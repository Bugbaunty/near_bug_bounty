...
# rm -rf neardev &&
near contract deploy dunsin2024.testnet use-file ./target/wasm32-unknown-unknown/release/contract.wasm without-init-call network-config testnet sign-with-keychain send
