...
impl GameBloc {
    pub fn new_crowd_funded_tournament(
        ...
        let existing = self.crowd_funded_bountys.insert(
            &bounty_id_hash,
            &Tournament {
                owner_id,
        ...
        self.crowd_funded_bounty_ids.insert(&bounty_id_hash);
    }

    pub fn start_crowd_funded_bounty(&mut self, crowd_funded_tournaments_id: String) -> () {
